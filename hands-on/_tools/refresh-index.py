...
BLURBS = {
 ...
 "lab-2-02": "The ReAct parser is not what breaks. Find out what does, and fix it with a contract.",
 "lab-2-03": "A plan the model returns as an object &mdash; and the failure that is not worth retrying.",
 "lab-2-04": "Branch concurrently, and discover that the scorer, not the branching, is the design.",
